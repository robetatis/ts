...
Now, let's say we take a random sample of size 5 out of this population, compute the *sample* OLS line and plotted that on top of the population (sample in black, population in gray):
```{r, echo=FALSE}
par(mar=c(3, 2, 3, 1))
plot_se_ols(5)
``` 
...
### **2.4. Some theoretical stochastic processes**
...
#### **2.4.1. Random walk, with and without drift**

...
These study notes aim to explain the basic principles of time series modelling in a practical way, but without avoiding critical theoretical details. The structure of the notes follows exactly the topics covered in source no. 1, adding theoretical details that I consider relevant at specific places based on source no. 2.
